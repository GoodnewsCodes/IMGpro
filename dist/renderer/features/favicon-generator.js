...
exports.initFaviconGenerator = initFaviconGenerator;
...
function initFaviconGenerator() {
    ...
    const originalPreview = document.getElementById("favicon-original-preview");
    const faviconGrid = document.getElementById("favicon-grid");
    const resetBtn = document.getElementById("favicon-reset-btn");
    const downloadAllBtn = document.getElementById("favicon-download-all-btn");
    ...
    async function generateFavicons(file) {
        ...
        try {
            ...
            if (icoResult.success && icoResult.buffer) {
                const blob = new Blob([icoResult.buffer], {
                    type: "image/x-icon",
                });
    ...
    function createGridItem(name, label) {
    ...
    function updateGridItem(item, blob, fileName) {
