export function initColorTools() {
  ...
  canvas.addEventListener("click", (e) => {
    ...
    if (pickedColorSwatch) pickedColorSwatch.style.backgroundColor = hex;
    if (pickedColorHex) pickedColorHex.value = hex.toUpperCase();
  });
  ...
  resetBtn.addEventListener("click", () => {
    ...
    if (pickedColorSwatch) pickedColorSwatch.style.backgroundColor = "#000000";
